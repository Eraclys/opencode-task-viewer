...
public sealed class SonarIssueNormalizerTests
{
    ...
    public void NormalizeForQueue_ReturnsNull_WhenKeyMissing()
    {
        ...
        var raw = new SonarIssueTransport(null, null, null, null, null, "javascript:S1126", null, null, null, null, null);
    ...
    {
        var mapping = CreateMapping();
        var raw = new SonarIssueTransport(null, "sq-2", null, "bug", "critical", "csharpsquid:S1118", "Add a private constructor", null, "alpha-key:src/File.cs", "18", "OPEN");
    ...
    {
        var mapping = CreateMapping();
        var raw = new SonarIssueTransport("sq-3", null, null, null, null, null, null, "other-project:lib/module.js", null, null, null);
