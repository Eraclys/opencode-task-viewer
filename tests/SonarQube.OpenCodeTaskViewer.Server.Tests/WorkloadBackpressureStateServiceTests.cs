...
public sealed class WorkloadBackpressureStateServiceTests
{
    ...
    {
        var working = new FakeWorkingSessionsReadService(
            7,
            new DateTimeOffset(
                2026,
                1,
    ...
    public async Task EvaluateAsync_TransitionsPausedState_AndNotifiesOnlyOnChange()
    {
        ...
        var third = await sut.EvaluateAsync(
            true,
            10,
            5,
            1000,
    ...
    {
        var sampleAt = new DateTimeOffset(
            2026,
            2,
            3,
            4,
        ...
        var sampled = await sut.EvaluateAsync(
            true,
            10,
            5,
            1000,
        ...
        var disabled = await sut.EvaluateAsync(
            false,
            0,
            0,
            1000,
    ...
    sealed class FakeWorkingSessionsReadService : IWorkingSessionsReadService
    {
