...
public sealed class FakeSonarQubeService : ISonarQubeService
{
    ...
    [
        ...
        new(
            ...
            "BLOCKER",
            "javascript:S5144",
            "Review this URL construction for SSRF risk.",
            "gamma-key:src/auth.js",
            null,
            "10",
            "OPEN"),
        new(
    ...
    public Task<SonarIssuesSearchResponse> SearchIssuesAsync(SearchIssuesQuery query, CancellationToken cancellationToken = default)
    {
        ...
        var rules = NormalizeSet(query.RuleKeys, true);
        var issueKeys = NormalizeSet(query.IssueKeys, true);
