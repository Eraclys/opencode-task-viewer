...
public sealed class OpenCodeApiClient : IOpenCodeStatusReader, IOpenCodeDispatchClient
{
    readonly Func<OpenCodeApiHttpClient> _createClient;
    readonly OpenCodeClientOptions _options;

    public OpenCodeApiClient(Func<OpenCodeApiHttpClient> createClient, OpenCodeClientOptions options)
    {
