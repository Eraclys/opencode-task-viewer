    ...
    public static IEndpointRouteBuilder MapOrchestrationEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        app
            .MapGet(
                ...
                async (
                    int? mappingId,
                    string? issueType,
                    IOrchestrationUseCases useCases,
        ...
        app
            .MapPost(
                ...
                async (
                    int taskId,
                    OrchestrationRequestParsers.TaskReviewPayload? body,
                    IOrchestrationUseCases useCases,
                    CancellationToken cancellationToken) =>
                {
        ...
        app
            .MapPost(
                    ...
                    CancellationToken cancellationToken) =>
                {
                    ...
                    var ok = await useCases.RepromptTaskAsync(
                        taskId,
                        review.Instructions ?? string.Empty,
                        review.Reason,
                        cancellationToken);
                    ...
                    if (!ok)
                        return Results.Json(
                            new ErrorResponseDto
                            {
                                Error = "Task not found or not repromptable"
                            },
                            statusCode: 404);
