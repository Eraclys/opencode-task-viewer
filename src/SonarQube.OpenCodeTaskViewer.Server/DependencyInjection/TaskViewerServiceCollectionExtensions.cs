...
using SonarQube.OpenCodeTaskViewer.Server.Infrastructure.ServerSentEvents;

namespace SonarQube.OpenCodeTaskViewer.Server.DependencyInjection;

static class TaskViewerServiceCollectionExtensions
{
        ...
        this IServiceCollection services)
    {
        ...
        services.AddTaskViewerOpenCode(sp =>
        {
        ...
        services.AddTaskViewerSonarQube(sp =>
        {
            var runtimeSettings = sp.GetRequiredService<AppRuntimeSettings>();
        ...
        services.AddTaskViewerPersistence(sp =>
        {
            var runtimeSettings = sp.GetRequiredService<AppRuntimeSettings>();
        ...
        services.AddSingleton<ISonarQubeService>(sp =>
        {
            var runtimeSettings = sp.GetRequiredService<AppRuntimeSettings>();
        ...
        services.AddSingleton<ISonarRulesReadService>(sp => new SonarRulesReadService(
    ...
    internal static IServiceCollection AddTaskViewerServerApplication(
        this IServiceCollection services)
    {
        services.AddSingleton<ISessionsUseCases>(sp => new SessionsUseCases(
