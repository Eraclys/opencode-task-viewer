...
public interface IOrchestrationGateway
{
    ...
    Task<object> ListIssues(object? mappingId, string? issueType, string? severity, string? issueStatus, object? page, object? pageSize, object? ruleKeys);
    Task<object> ListRules(object? mappingId, string? issueType, string? issueStatus);
    Task<object> EnqueueIssues(object? mappingId, string? issueType, string? instructions, JsonArray? issues);
    Task<object> EnqueueAllMatching(object? mappingId, string? issueType, object? ruleKeys, string? issueStatus, string? severity, string? instructions);
