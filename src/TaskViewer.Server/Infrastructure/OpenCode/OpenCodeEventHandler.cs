...
sealed class OpenCodeEventHandler
{
    ...
    public OpenCodeEventHandler(OpenCodeViewerCacheCoordinator cacheCoordinator, SseHub sseHub, OpenCodeCacheInvalidationPolicy cacheInvalidationPolicy)
    {
